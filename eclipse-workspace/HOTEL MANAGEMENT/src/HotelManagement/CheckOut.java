...
public class CheckOut extends JFrame{
	...
	public CheckOut() throws SQLException {
		...
		contentPane.setLayout(null);
                ...
                ImageIcon i1  = new ImageIcon(ClassLoader.getSystemResource("HotelManagement/Icons/CheckOut.jpg"));
                ...
                l2.addActionListener(new ActionListener(){
                    ...
                    public void actionPerformed(ActionEvent ae){
                        ...
                        try{
                            ...
                            ResultSet rs = c.s.executeQuery("select * from customer where number1 = "+number);
		...
		btnCheckOut.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				String deleteSQL = "Delete from customer where number1 = "+id;
