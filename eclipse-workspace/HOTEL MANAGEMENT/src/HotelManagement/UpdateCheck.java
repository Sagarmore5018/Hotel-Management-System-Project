...
public class UpdateCheck extends JFrame {
	...
	public UpdateCheck() throws SQLException {
		...
		ImageIcon i1  = new ImageIcon(ClassLoader.getSystemResource("HotelManagement/icons/CheckIn.jpg"));
		...
		contentPane.add(txt_ID);
         ...
         try{
             ...
             ResultSet rs = c.s.executeQuery("select * from customer");
             while(rs.next()){
                 c3.add(rs.getString("room_number1"));    
             }
         }catch(Exception e){ }
         c3.setBounds(248, 126, 140, 20);
         contentPane.add(c3);
		...
		btnUpdate.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent ae) { 
                            try{
                                ...
                                c.s.executeUpdate("update customer set room_number = '"+s2+"', name1 = '"+s3+"', checked_in1 = '"+s4+"', deposit1 = '"+s5+"' where number1 = '"+s1+"'");
		...
		btnAdd.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				conn c = new conn();
                                ...
                                while(rs1.next()){
//                                    txt_ID.setText(rs1.getString("number1"));    
                                    txt_Status.setText(rs1.getString("name1"));    
                                    txt_Date.setText(rs1.getString("room_number1"));    
                                    txt_Time.setText(rs1.getString("deposit1"));    
                                }
                            }catch(Exception ee){
                            	System.out.println(ee);
                            }
